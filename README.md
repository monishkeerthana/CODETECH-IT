...
<head>
    ...
    <title>E-Commerce Design Project</title>
</head>
<body>
    ...
    <h2>How to View the Design</h2>
    <p>To view the design, you can <a href="#">visit the Figma project link here</a> (replace with the actual link).</p>
